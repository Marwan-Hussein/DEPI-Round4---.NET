    ...
    public partial class MakeAllModelsAsTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCourseResult", x => new { x.StudentId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_StudentCourseResult_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentCourseResult_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCourseResult_CourseId",
                table: "StudentCourseResult",
                column: "CourseId");
